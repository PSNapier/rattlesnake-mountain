...
const breadcrumbs: BreadcrumbItem[] = [
	...
	{
		title: 'Edit',
		href: `/herds/${props.herd.id}/edit`,
	},
];

const form = useForm({
	name: props.herd.name,
	herd_leader_id: props.herd.herd_leader_id,
	herd_members: props.herd.herd_members,
	inventory: props.herd.inventory,
	equipment: props.herd.equipment,
});
...
<template>
	<Head title="Edit Herd" />

	<AppLayout :breadcrumbs="breadcrumbs">
		<div class="mx-auto max-w-2xl">
			<div class="space-y-6">
				<div>
					<h1 class="text-3xl font-bold">Edit Herd</h1>
					<p class="text-gray-600">
						Update your herd information.
					</p>
				</div>
